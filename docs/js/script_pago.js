...
let aFecha1 = new Date(datosReserva.dateStart);
let aFecha2 = new Date(datosReserva.dateEnd);

let mili = 24 * 60 * 60 * 1000;
let miliT = Math.abs(aFecha1.getTime() - aFecha2.getTime());
let dias = Math.round(miliT / mili);

var precio = parseFloat(datosReserva.costo) * dias;
...
document.getElementById('costoHosp').innerText = ("¢" + precio);
